...
trait ParametersPagination
{
    ...
    public function paginate()
    {
        ...
        $query->leftJoin('netcore_product__parameter_translations as translations', function (JoinClause $join) {
        ...
        $datatable->addColumn('categories', function(Parameter $parameter) {
            return view('product::parameters.tds.categories', compact('parameter'));
        });
