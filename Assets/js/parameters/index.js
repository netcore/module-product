...
$(function () {
    var datatable = $('#parameters-datatable').dataTable({
        processing: true,
        serverSide: true,
    ...
    // Delete button.
    $('#parameters-datatable').on('click', '.delete-parameter', function (e) {
        e.preventDefault();
        ...
        swal({
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete(route).then(function (_ref) {
                var data = _ref.data;
