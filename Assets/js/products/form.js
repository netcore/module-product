...
new Vue({
    ...
    components: {
        'product-form': __webpack_require__(55)
    }
});
...
var update = __webpack_require__(39)("5c431073", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__event_bus__ = __webpack_require__(59);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            currentLanguage: __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.first(this.languages), 'iso_code', 'en'),
            isLoading: false
        };
    },
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_3__event_bus__["a" /* default */].$on('product::loadingState', function (state) {
    ...
    methods: {
        fetchFields: function fetchFields() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.fieldsRoute, {
                params: {
                ...
                _this2.productFields = data;
                _this2.mockProductFields();
        ...
        fetchProduct: function fetchProduct() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.productRoute).then(function (_ref2) {
                var data = _ref2.data;
        ...
        mockProductFields: function mockProductFields() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(this.productFields, function (field) {
                // Keep existing field.
                if (__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.has(_this4.product.fieldsData, field.id)) {
                    return;
                }
                ...
                if (field.is_translatable) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(_this4.languages, function (language) {
                ...
                _this4.product.fieldsData[field.id] = fieldObject;
            });
        },
        saveProduct: function saveProduct() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(this.route, form).then(function (_ref3) {
                var data = _ref3.data;
                ...
                if (data.refresh) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_3__event_bus__["a" /* default */].$emit('product::saved');
                }
            }).catch(function (err) {
        ...
        addProductVariant: function addProductVariant() {
            this.product.variants.push({
                key: __WEBPACK_IMPORTED_MODULE_2__global_helpers__["a" /* default */].randomString(10),
                parameters: [],
                images: [],
                prices: this.mockProductPrices(),
        ...
        mockTranslationsObject: function mockTranslationsObject(fields) {
            var translations = {};

            __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(this.languages, function (language) {
                translations[language.iso_code] = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.clone(fields);
            });

            return translations;
        },
        mockProductPrices: function mockProductPrices(product) {
            var prices = {};
    ...
    components: {
        'product-variant': __webpack_require__(60),
        'product-field': __webpack_require__(61),
        'select2': window.Select2
    },

    watch: {
        'product.categories': function productCategories() {
            this.fetchFields();
        }
    }
});
...
Component.options.__file = "Resources/assets/js/components/Product/ProductVariant.vue"
...
Component.options.__file = "Resources/assets/js/components/Product/Field.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7e9c2233", Component.options)
  } else {
    hotAPI.reload("data-v-7e9c2233", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7e9c2233", module.exports)
  }
}
  ...
  return _c(
    ...
    [
      _c("input", {
        ...
        attrs: { type: "hidden", name: "is_variable" },
        domProps: { value: _vm.product.is_variable },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.product, "is_variable", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
      _c("div", { staticClass: "panel-heading" }, [
        _vm.productRoute
          ? _c("span", { staticClass: "panel-title" }, [_vm._v("Edit product")])
                    ...
                    return _c(
                      ...
                      _vm._l(_vm.translatableFields, function(field) {
                        return _c("product-field", {
                          ...
                          model: {
                            value:
                              _vm.product.fieldsData[field.id].translations[
                                language.iso_code
                              ].value,
                            callback: function($$v) {
                              _vm.$set(
                            ...
                            expression:
                              "product.fieldsData[field.id].translations[language.iso_code].value"
                          }
                        })
                      })
                    )
                  ...
                  _c(
                    ...
                    _vm._l(_vm.nonTranslatableFields, function(field) {
                      return _c("product-field", {
                        ...
                        model: {
                          value: _vm.product.fieldsData[field.id].value,
                          callback: function($$v) {
                            _vm.$set(
                              _vm.product.fieldsData[field.id],
                              "value",
                              $$v
                            )
                          },
                          expression: "product.fieldsData[field.id].value"
                        }
                      })
                    })
                  )
                        ...
                        [
                          _c("product-variant", {
                            attrs: {
                              ...
                              "is-variable": _vm.product.is_variable,
                              "image-reorder-route": _vm.imageReorderRoute
                            },
                            on: {
      ...
      _c("div", { staticClass: "panel-footer text-right" }, [
        _c("button", { staticClass: "btn btn-success" }, [
          ...
          _vm._v(
            " " + _vm._s(_vm.productRoute ? "Update" : "Create") + "\n        "
          )
        ])
      ])
    ]
